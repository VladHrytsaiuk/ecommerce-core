...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_identity_delivery_http.emailCodeRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/auth/email-code/verify": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Address and code",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_identity_delivery_http.emailCodeVerifyRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_identity_delivery_http.accountResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_identity_delivery_http.phoneCodeRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_identity_delivery_http.phoneCodeVerifyRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "internal_identity_delivery_http.accountResponse": {
            "type": "object",
            "properties": {
                "email": {
                    "description": "Email and Phone are the account's own contacts, absent where it has none.",
                    "type": "string"
                },
                "email_verified": {
                    "description": "EmailVerified and PhoneVerified say which contacts have been proved; a\nstore may require a verified one at checkout.",
                    "type": "boolean"
                },
                "has_password": {
                    "type": "boolean"
        ...
        "internal_identity_delivery_http.emailCodeRequest": {
            "type": "object",
            "required": [
                "email"
            ],
        ...
        "internal_identity_delivery_http.emailCodeVerifyRequest": {
            "type": "object",
            "required": [
                "code",
                "email"
        ...
        "internal_identity_delivery_http.phoneCodeRequest": {
            "type": "object",
            "required": [
                "phone"
            ],
        ...
        "internal_identity_delivery_http.phoneCodeVerifyRequest": {
            "type": "object",
            "required": [
                "code",
                "phone"
